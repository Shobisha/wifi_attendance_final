                ...
                <div className="contactco" id="contact-col">
                    <div className="row mainco">
                        ...
                        <div className="col-xs-12 col-sm-6 contactstyleco">
                            ...
                            <div className="col-sm-12" style={{ visibility: 'hidden' }}>
                                <hr />
                            </div>
                            <form method="post" id="form_subt">
                                <div className="form-group fieldgap">
                                    <input type="text" className="form-control inputtxt" placeholder="Name" id="Inputname" name="your_name" required="" />
                                </div>
                                <div className="form-group fieldgap">
                                    <input type="email" className="form-control inputtxt" placeholder="Email" name="your_email" required="" />
                                </div>

                                <div className="form-group fieldgap">
                                    <input type="text" className="form-control inputtxt" placeholder="Subject" name="your_sub" required="" />
                                </div>
                                <div className="form-group fieldgap">
                                    <textarea className="form-control inputtxt h-auto" rows="6" placeholder="Message" name="your_message"></textarea>
                                </div>
                                <span id="form_error formserror"></span>
                                <span id="form_success formsuccess"></span>
                                <div className="form-group fieldgap" style={{ position: 'relative' }}>
                                    <input type="hidden" id="current_page" value="Contact Us" />
                                    <input type="submit" value="SUBMIT" className="inputsubmit" id="user_submit" />
                                    <div className="loaderco"></div>
                                </div>
                            </form>
                        </div>
                    </div>
