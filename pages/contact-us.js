    ...
    <>
      ...
      <div className="mainsection">
        ...
        <section id="map" className="mapco">
          <p className="maptextco">
            Interested in{" "}
            <span className="spantxt">Wifiattendance Management System</span>?
          </p>
          ...
          <div className="contactco" id="contact-col">
            <div className="row mainco">
              <div className="col-xs-12 col-sm-6 addstyleco centerco">
                ...
                <p className="para">
                  Wi-fi Attendance, Floor-3, Edsys Towers,
                  <br /> Near ICICI Bank ATM, Kamaleswaram, <br />
                  Trivandrum, Kerala-695009
                </p>

                <h4 className="hfour">PUNE</h4>
                <p className="para">
                  Wi-fi Attendance, 2nd Floor, 125/2, Sainiketan <br /> Colony
                  Kalas road, Visharant Wadi, Pune,
                  <br /> Maharashtra-411015
                </p>
                ...
                <div className="row">
                  <div className="col-xs-12  col-sm-12">
                    <p className="para">
                      ...
                      <a href="tel:+91 811 386 3000" className="alink">
                        +91 811 386 3000
                      </a>
                    </p>
                    ...
                    <p className="para">
                      ...
                      <a
                        href="mailto:info@wifiattendance.com"
                        className="alink"
                      >
                        info@wifiattendance.com
                      </a>
                    </p>
                  </div>
                </div>
                ...
                <div className="col-sm-12 addricons">
                  ...
                  <a
                    href="https://twitter.com/wifi_attendance"
                    className="asocial"
                  >
              ...
              <div className="col-xs-12 col-sm-6 contactstyleco">
                ...
                <form method="post" id="form_subt">
                  ...
                  <div className="form-group fieldgap">
                    <textarea
                      className="form-control inputtxt h-auto"
                      rows="6"
                      placeholder="Message"
                      name="your_message"
                    ></textarea>
